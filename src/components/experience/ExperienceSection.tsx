...
const timelineData: TimelineItem[] = [
  {
    ...
    description:
      'Acquired hands-on expertise in cloud architecture design, security implementation, and deployment strategies. Developed serverless applications using AWS API Gateway, Lambda, and DynamoDB following the AWS Well-Architected Framework.',
    tech: ['AWS Lambda', 'API Gateway', 'DynamoDB', 'IAM', 'CloudWatch'],
  ...
  },
  {
    ...
    organization: 'Golden Gate Global School',
    description: 'Completed higher secondary education in Moradabad, Uttar Pradesh with 82%. Received Academic Excellence Award for consistent high performance.',
